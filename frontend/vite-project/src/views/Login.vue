    ...
    <div class="container" :class="{ active: isSignup }">
      <div class="forms">
        <div class="form login">
          <span class="title">Login on Hooker</span>
        ...
        <div class="form signup">
          <span class="title">Registration on Hooker</span>
...
function signinUser() {
  ...
  const loginUrl = 'http://localhost:9090/hooker/v1.0/login'; // Replace with your server URL
...
function signupUser() {
  ...
  const registrationUrl = 'http://localhost:9090/hooker/v1.0/register'; // Replace with your server URL
...
.input-field-country select:hover, .input-field select:focus {
  border-color: #4070f4;
}
